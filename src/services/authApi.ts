...
export interface LoginResult { user: { id: string; email: string; displayName: string; platformAccess: boolean }; onboarding: { step: number; completed: boolean; next: string }; session: AuthSessionPayload }
